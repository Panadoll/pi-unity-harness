...
namespace io.github.hatayama.UnityCliLoop.FirstPartyTools
{
    ...
    public class EnablePausePointTool : UnityCliLoopTool<EnablePausePointSchema, PausePointResponse>
    {
        ...
        public Task<PausePointResponse> ExecuteForHarness(EnablePausePointSchema parameters, CancellationToken ct)
        {
    ...
    public class ClearPausePointTool : UnityCliLoopTool<ClearPausePointSchema, PausePointResponse>
    {
        ...
        public Task<PausePointResponse> ExecuteForHarness(ClearPausePointSchema parameters, CancellationToken ct)
        {
            return ExecuteAsync(parameters, ct);
        }
